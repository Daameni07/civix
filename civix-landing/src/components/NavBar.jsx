  ...
  return (
    <nav className="flex justify-between items-center px-10 py-6 text-blue-900">
      ...
      <div className="flex items-center space-x-8 text-lg font-bold">
       <Link
  to="/"
  className="hover:text-blue-700 hover:underline transition duration-300">Home</Link>
        <Link
  to="/dashboard"
...
>
  Officials
        ...
        <button className="bg-brand-btn text-white px-5 py-2 rounded-md text-base font-semibold hover:bg-blue-800 transition">
          Sign Out
        </button>
      </div>
    </nav>
