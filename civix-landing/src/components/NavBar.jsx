  ...
  return (
    <nav className="flex justify-between items-center px-10 py-6 text-blue-900">
      ...
      <div className="flex items-center space-x-8 text-lg font-bold">
        ...
        <Link
          to={role === "citizen" ? "/dashboard/citizen/petitions" : "/dashboard/official/petitions"}
          className="hover:text-blue-700 hover:underline transition duration-300"
        >
          Petitions
        </Link>

        <Link to="/polls" className="hover:text-blue-700 hover:underline transition duration-300">
          Polls
        </Link>

        <Link to="/officials" className="hover:text-blue-700 hover:underline transition duration-300">
          Settings
        </Link>
      </div>
    </nav>
